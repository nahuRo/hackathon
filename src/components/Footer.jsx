...
const Footer = () => {
	return (
		<div className="max-w-screen-lg my-0 mx-auto py-[100px] flex flex-row justify-around">
			...
			<div className="flex flex-col gap-y-4">
				...
				<span>
					Whatsapp o correo electrónico <br /> hello@wirebit.com
				</span>
				<span>
					Lunes a Viernes de 9:00 am a 6:00 pm <br /> horario del centro de México.
				</span>
			</div>
			<div className="flex flex-col gap-y-4">
